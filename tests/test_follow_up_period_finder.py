...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Subjects attended scheduled follow‑up visits at month 3.",
            False,
            "v1_neg_visit_trap",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Participants were followed for 24 months post‑randomization.",
            True,
            "v2_pos_24_months",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Participants were followed for a mean of 24 months.",
            True,
            "v4_pos_mean_followed_for",
        ),
        # negative: qualifier but no duration
        (
            "Median follow‑up was assessed qualitatively.",
            False,
            "v4_neg_qualifier_no_duration",
        ),
