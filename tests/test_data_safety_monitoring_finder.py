...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Periodic safety review was performed by the DSMB.",
            True,
            "v1_pos_periodic_review",
        ),
        (
            "Monitoring of data quality was performed.",
            False,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Monitoring of DSMB activities was described.",
            False,
            "v2_neg_trap_monitoring",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "An independent DSMB reviewed safety data quarterly.",
            True,
            "v4_pos_independent_quarterly",
        ),
        ...
        (
            "DSMB met; study safety information not mentioned.",
            False,
            "v4_neg_missing_safety",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "An independent DSMB met quarterly to review safety data.",
            True,
            "v5_pos_template",
        ),
        (
            "Independent DMC met to review safety data for adverse events.",
            True,
            "v5_pos_template_dmc",
        ),
