...
@pytest.mark.parametrize(
    ...
    [
        (
            "The results are generalizable to other populations.",
            True,
            "v1_pos_generalizable",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Results should be interpreted with caution regarding applicability.",
            True,
            "v2_pos_modal_caution",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Findings may not generalize to older adults or women.",
            True,
            "v4_pos_pop_qual",
        ),
