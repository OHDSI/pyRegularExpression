...
@pytest.mark.parametrize(
    ...
    [
        (
            "Event Adjudication:\nAll events were adjudicated by a committee.",
            True,
            "v3_pos_heading_block",
        ),
        (
            "Clinical Events Committee:\nEndpoint adjudication was performed.",
            True,
            "v3_pos_committee_block",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "All MI events were independently adjudicated by a blinded CEC.",
            True,
            "v4_pos_independent_blinded",
        ),
        (
            "Endpoint adjudicated by an independent committee.",
            True,
            "v4_pos_committee_independent",
        ),
        (
            "All events were adjudicated without committee oversight.",
            False,
            "v4_neg_no_blind_or_committee",
        ),
    ],
)
