...
@pytest.mark.parametrize(
    ...
    [
        (
            "The intervention group received the drug.",
            True,
            "v2_pos_intervention_action",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Experimental arm received drug; control group given placebo.",
            True,
            "v4_pos_control",
        ),
        (
            "Intervention arm treated with medication, no control.",
            False,
            "v4_neg_no_control",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Experimental arm received drug; control arm received placebo.",
            True,
            "v5_pos_template",
        ),
