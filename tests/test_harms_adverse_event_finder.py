...
@pytest.mark.parametrize(
    ...
    [
        (
            "Adverse Events:\n15% of patients experienced headache.",
            True,
...
@pytest.mark.parametrize(
    ...
    [
        (
            "15 % headaches in treatment vs 10 % placebo; no serious events.",
            True,
            "v5_pos_template",
        ),
        (
            "15 % headaches in treatment group; some events.",
            False,
            "v5_neg_loose_template",
        ),
    ],
)
