...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Investigators conducted a blinded review of pathology reports.",
            False,
            "v1_miss_review",
        ),
        ("The study was open label with no blinding.", True, "v1_miss_open"),
        (
            "Masked outcome assessors recorded all events.",
            True,
            "v1_hit_masked_assessors",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Masked outcome assessors recorded all events.",
            True,
            "v2_hit_masked_assessor",
        ),
        (
            "Double-blind protocol: investigators conducted analysis.",
            True,
            "v2_hit_double_investigators",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Blinding:\nDouble-blind study with masked participants.",
            True,
            "v3_hit_heading_block",
        ),
        (
            "Masking:\nSingle-blind trial for outcome assessors.",
            True,
            "v3_hit_heading_block_single",
        ),
        (
            "Introduction:\nDouble-blind study for participants.",
            False,
            "v3_miss_wrong_block",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Double-blind study: participants and assessors were unaware.",
            True,
            "v4_hit_double_two_roles",
        ),
        (
            "Triple-blind trial with participants, assessors, and clinicians masked.",
            True,
            "v4_hit_triple_multiple_roles",
        ),
        (
            "Single-blind trial: participants were masked.",
            False,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Single-blind trial: participants were masked.",
            False,
            "v5_miss_single_template",
        ),
        (
            "Triple-blind study: participants and assessors were unaware.",
            False,
            "v5_miss_triple_template",
        ),
        (
            "Masked participants in an open-label study.",
            False,
            "v5_miss_masked_open_label",
        ),
    ],
)
