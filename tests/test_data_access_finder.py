...
@pytest.mark.parametrize(
    ...
    [
        (
            "Data are available upon request from the PI.",
            True,
            "v2_pos_available_near_data",
        ),
        ...
        (
            "Clinical outcomes were accessible to investigators.",
            False,
            "v2_neg_outcomes_only",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Acknowledgements:\nWe thank participants for providing data.",
            False,
            "v3_neg_ack_no_access",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "The dataset is available upon request with IRB approval.",
            True,
            "v4_pos_request_irb",
        ),
        ...
        (
            ...
            False,
            "v4_neg_no_repo_or_permission",
        ),
        (
            "Dataset is accessible in supplementary files.",
            False,
            "v4_neg_no_permission_or_repo",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Data are available upon reasonable request with institutional approval.",
            True,
            "v5_pos_request_approval",
        ),
        (
            "Dataset is deposited in the Dryad repository under accession 12345.",
            True,
            "v5_pos_repo_template",
        ),
