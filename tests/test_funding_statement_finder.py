...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "We received funding from the NIH (grant number R01 HG006139).",
            True,
        ...
        (
            ...
            True,
            "v1_pos_negative_declaration",
        ),
        # Negative examples
        (
            "This study utilized the OMOP CDM and OHDSI tools.",
            False,
            "v1_neg_no_funding_info",
        ),
        (
            "All code used is available at github.com/OHDSI.",
            False,
            "v1_neg_open_source_note",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Janssen provided research funding for this project.",
            True,
        ...
        # Negative examples
        (
            "NIH R01 LM006910 appears in the disclosures.",
            False,
            "v2_neg_grant_mentioned_but_no_cue",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Funding:\nSupported by NIH grant R01 LM006910 and NSF IIS 1251151.",
            True,
            "v3_pos_funding_block_heading",
        ),
        (
            "Financial Support:\nJanssen contributed to infrastructure funding.",
            True,
            "v3_pos_financial_support_block",
        ),
        # Negative examples
        (
            "Acknowledgements:\nThanks to the reviewers and collaborators.",
            False,
            "v3_neg_ack_no_funding",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "This project was funded by Janssen and supported by NIH R01 LM006910.",
            True,
            "v4_pos_combo_janssen_and_nih",
        ),
        # Negative
        (
            "Support was internal only; no external funders participated.",
            False,
            "v4_neg_internal_support_only",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Supported by NIH grant R01 LM006910.",
            True,
            "v5_pos_supported_by_exact_template",
        ),
        (
            "Supported by NSF grant IIS 1251151 and NIH grant R01 HG006139.",
            True,
            "v5_pos_supported_multiple_grants",
        ),
        (
            "This work was supported by a grant from the FDA (R01 LM006910).",
            False,
            "v5_neg_indirect_wording",
        ),
        (
            "Funding provided via collaborative agreement with no grant number.",
            False,
            "v5_neg_missing_grant_number",
        ),
    ],
)
