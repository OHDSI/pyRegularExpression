...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "Baseline characteristics: Mean age 63 years, 45% male.",
            True,
            "v1_pos_age_pct",
        ),
        (
            "At baseline, BMI was 27.5 ± 4.1.",
            True,
            "v1_pos_at_baseline_numeric",
        ),
        (
            "Table 1 shows demographics including 30% smokers.",
            True,
            "v1_pos_table_with_percentage",
        ),
        # Negative examples
        ("Baseline tumor location was recorded.", False, "v1_neg_no_number"),
        (
            "Participants were enrolled from multiple centers.",
            False,
            "v1_neg_no_baseline_cue",
        ),
        (
            "The majority were male.",
            False,
            "v1_neg_no_baseline_or_number",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "Mean age at baseline was 54 vs 55 years in treatment and placebo groups.",
            True,
            "v2_pos_vs_with_groups",
        ),
        (
            "Table 1: 60% female in the treatment group, 58% in placebo.",
            True,
            "v2_pos_group_labels",
        ),
        (
            "Baseline BMI was 29.4 ± 5.1 compared to 27.1 ± 4.9.",
            True,
            "v2_pos_compared_to",
        ),
        # Negative examples
        (
            "Baseline BMI was 27.3 for the entire cohort.",
            False,
            "v2_neg_no_group_comparison",
        ),
        (
            "Baseline characteristics: Mean age 63.",
            False,
            "v2_neg_number_but_no_group_term",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "At baseline: age 55 vs 57, BMI 29.3 vs 27.4.",
            True,
            "v4_pos_multiple_variables",
        ),
        (
            "Baseline characteristics: 63% male vs 60%, mean age 54 vs 55.",
            True,
            "v4_pos_pct_and_age",
        ),
        (
            "Baseline: BMI 29.4 in treatment vs 28.7 placebo.",
            True,
            "v4_pos_two_numbers_one_var",
        ),
        # Negative examples
        (
            "At baseline, heart rate was measured.",
            False,
            "v4_neg_no_group_no_multiple_numbers",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "Mean age 54 vs 55; 60 % female in both groups at baseline.",
            True,
            "v5_pos_mean_age_pct_both_groups",
        ),
        (
            "Baseline: 70% male vs 68% male; median age 52 vs 50.",
            True,
            "v5_pos_compact_template",
        ),
        # Negative examples
        (
            "Baseline BMI 28.5 in treatment and 28.3 in placebo.",
            False,
            "v5_neg_not_enough_structure",
        ),
        (
            "At baseline: mean age 54; no gender data reported.",
            False,
            "v5_neg_missing_comparison_structure",
        ),
    ],
)
