...
Includes:
- Robust tests for v1 and v2 (basic gap/rationale cues and context-aware
  co-occurrence with "study")
- Functional checks for v3, v4, and v5 (block-based, unmet-need phrase
  filters, and tight template matches)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Prior studies have shown that adherence impacts outcomes.",
            True,
            "v1_pos_prior_studies",
        ),
        (
            "However, little is known about long-term effects.",
            True,
            "v1_pos_little_known",
        ),
        (
            "There is an important gap in understanding this population.",
            True,
            "v1_pos_important_gap",
        ),
        (
        ...
        (
            "Protocol approved by XYZ IRB #2021-45; informed consent obtained.",
            False,
            "v1_neg_irb",
        ),
        (
        ...
        (
            "Study followed ethical principles of the Declaration of Helsinki.",
            False,
            "v1_neg_guidelines",
        ),
        (
            "Ethically conducted research procedures were applied.",
            False,
            "v1_neg_generic",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Prior studies have shown unknown effects of this therapy; "
            "this study investigates.",
            True,
            "v2_pos_multiple_gaps",
        ),
        (
            "Little is known about these populations, "
            "and the study aims to examine it.",
            True,
            "v2_pos_gap_plus_study",
        ),
        (
            "Important gap exists, and evidence is limited.",
            True,
            "v2_pos_two_gap_phrases",
        ),
        (
            "This research explores known mechanisms.",
            False,
            "v2_neg_single_known_phrase",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Introduction:\nPrior studies have shown limited evidence.",
            True,
            "v3_pos_introduction_heading",
        ),
        (
            "Background:\nHowever, little is known about this topic.",
            True,
            "v3_pos_background_heading",
        ),
        (
            "Results:\nPrior studies have shown limited evidence.",
            False,
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Little is known about adherence, and this study investigates.",
            True,
            "v4_pos_unmet_need",
        ),
        (
            "Not well understood mechanisms were explored in this study.",
            True,
            "v4_pos_not_well_understood",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "However, little is known about adherence; "
            "therefore this study aims to investigate.",
            True,
            "v5_pos_tight_template",
        ),
        (
            "Yet unknown mechanisms exist; this study aims to examine them.",
            True,
            "v5_pos_tight_template_alt",
        ),
        (
            "Little is known about adherence, and we explore it.",
            False,
            "v5_neg_missing_contrast_connector",
        ),
