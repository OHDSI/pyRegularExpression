...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Data sharing statement included in manuscript.",
            True,
            "v1_pos_data_sharing_stmt",
        ),
        ("Publicly available census data were used.", False, "v1_neg_trap_public"),
        (
            "Open access dataset description provided.",
            False,
            "v1_neg_trap_open_access",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Dataset deposited in Dryad after publication.",
            True,
            "v2_pos_repo_deposit",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            True,
            "v3_pos_heading_shared",
        ),
        (
            "Availability Statement - Datasets deposited in Dryad.",
            True,
            "v3_pos_heading_dryad",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Dataset deposited in Zenodo and accessible to researchers.",
            True,
            "v4_pos_repo_zenodo",
        ),
        (
            "Data sharing statement included without access info.",
            False,
            "v4_neg_no_access_mech",
        ),
        (
            "Data available but no repository or request info.",
            False,
            "v4_neg_missing_mech",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Individual participant data will be available in Dryad after publication.",
            True,
            "v5_pos_template_dryad",
        ),
        (
            "Data will be available upon request after study completion.",
            True,
            "v5_pos_template_request",
        ),
        (
            "Datasets deposited but no access details provided.",
            False,
            "v5_neg_loose_phrase",
        ),
    ],
