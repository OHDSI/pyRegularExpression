...
@pytest.mark.parametrize(
    ...
    [
        (
            "The provenance of source data was carefully evaluated.",
            True,
            "v1_pos_provenance",
        ),
        ("An audit trail ensured data integrity.", True, "v1_pos_audit_trail"),
        (
            "We assessed lineage across multiple transformations.",
            True,
            "v1_pos_lineage",
        ),
        (
            "The dataset was analyzed without mentioning its history.",
            False,
            "v1_neg_no_provenance",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Data provenance was documented in the clinical trial records.",
            True,
            "v2_pos_provenance_documented",
        ),
        (
            "The origin of the data was tracked throughout the ETL process.",
            True,
            "v2_pos_origin_tracked",
        ),
        (
            "Audit trail maintained provenance information.",
            True,
            "v2_pos_audit_trail_maintained",
        ),
        (
            "Provenance of data is important, but no action verb mentioned.",
            False,
            "v2_neg_no_verb",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Methods:\nData provenance was evaluated for each dataset.",
            True,
            "v3_pos_methods_block",
        ),
        (
            "Data Source:\nThe lineage of clinical records was documented.",
            True,
            "v3_pos_datasource_block",
        ),
        (
            "Results:\nProvenance of the dataset was briefly discussed.",
            False,
            "v3_neg_results_section",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Data provenance was recorded for each raw data file.",
            True,
            "v4_pos_raw_data",
        ),
        (
            "The lineage was tracked in the clinical record system.",
            True,
            "v4_pos_clinical_record",
        ),
        (
            "Audit trail documented provenance, but no dataset mentioned.",
            False,
            "v4_neg_no_dataset",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "The provenance was recorded and the audit trail ensured lineage.",
            True,
            "v5_pos_alt_template",
        ),
        (
            "Provenance mentioned but without audit trail or lineage.",
            False,
            "v5_neg_incomplete",
        ),
    ],
