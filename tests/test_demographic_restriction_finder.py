...
@pytest.mark.parametrize(
    ...
    [
        (
            "Participants aged 18–65 were included in the trial.",
            True,
            "v2_pos_age_included",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Eligibility:\nParticipants aged 18–65 were recruited.",
            True,
            "v3_pos_block_age",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Participants had to be aged 18–65 to enroll.",
            True,
            "v5_pos_template_age",
        ),
        (
            "Patients must be adults between 18 and 65.",
            True,
            "v5_pos_template_adults",
        ),
