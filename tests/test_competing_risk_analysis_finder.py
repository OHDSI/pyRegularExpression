...
- Functional checks for v3, v4, and v5 (heading blocks, numeric/technique context,
  and tight templates)
...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "Competing risk analysis was performed for death vs transplant.",
            True,
            "v1_pos_competing_risk",
        ),
        (
            "Fine-Gray models were applied to assess event probability.",
            True,
            "v1_pos_fine_gray",
        ),
        ...
        (
            "There is high competition for resources in the ICU.",
            False,
            "v1_trap_resource_competition",
        ),
        (
            "Risk of fracture was compared using Cox regression.",
            False,
            "v1_trap_cox_regression",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "We fitted Fine-Gray models to estimate competing risk outcomes.",
            True,
            "v2_pos_fitted_finegray",
        ),
        (
            "Sub-hazard ratio was estimated in a competing risk framework.",
            True,
            "v2_pos_estimated_shr",
        ),
        # Trap examples
        (
            "Fine-Gray method described in discussion without modelling.",
            False,
            "v2_trap_no_modeling_verb",
        ),
        (
            "Competition for resources was used as an example.",
            False,
            "v2_trap_resource_usage",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "Competing Risk:\nWe used Fine-Gray methods for transplant analysis.",
            True,
...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "We fitted Fine-Gray models to estimate sHRs for competing risk.",
            True,
        ...
        # Negative examples
        (
            "We applied models to study competing risk without specifying Fine-Gray.",
            False,
            "v4_neg_missing_technique",
        ),
        (
            "Fine-Gray was mentioned, but no modelling verb was present.",
            False,
            "v4_neg_missing_verb",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "We fitted Fine-Gray models to estimate sHRs for death vs transplant.",
            True,
            "v5_pos_fitted_finegray_template",
        ),
        # Negative examples
        (
            "We applied Fine-Gray models but did not report sHRs.",
            False,
            "v5_neg_missing_shr",
        ),
        (
            "Sub-hazard ratios were estimated, but no Fine-Gray fitting was described.",
            False,
            "v5_neg_missing_fitted_template",
        ),
    ],
)
