...
@pytest.mark.parametrize(
    ...
    [
        (
            "Patients were followed until death or retransplantation.",
            True,
            "v1_pos_pubmed_death_transplant",
        ),
        (
            "All patients were followed until death, transplantation or December 31st, 2017.",
            True,
            "v1_pos_pubmed_date",
        ),
        ("Patients were censored at study end.", True, "v1_pos_censored_at"),
        (
            "Participants were followed until June 2010.",
            True,
            "v1_pos_followed_until_month",
        ),
        ("Follow-up ended after 24 months.", True, "v1_pos_followup_ended_time"),
        (
            "Censored on the date of last contact.",
            True,
            "v1_pos_censored_last_contact",
        ),
        ("The study ended in 2018.", False, "v1_neg_study_ended_trap"),
        (
            "Five individuals were lost to follow-up.",
            False,
            "v1_neg_lost_followup_trap",
        ),
        (
            "Patients withdrew consent before the second visit.",
            False,
            "v1_neg_withdrew_consent",
        ),
        (
            "Study completion was determined administratively.",
            False,
            "v1_neg_admin_completion",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Patients were followed until death or transplant.",
            True,
            "v2_pos_followed_until_event",
        ),
        (
            "All patients were followed until death, transplantation or December 31st, 2017.",
            True,
        ...
        (
            "Censored at whichever occurred first: death or graft loss.",
            True,
            "v2_pos_whichever_keyword",
        ),
        ("Exit at the earlier of transplant or death.", True, "v2_pos_earlier_of"),
        (
            "Participants were censored when the event occurred.",
            True,
            "v2_pos_censored_when",
        ),
        (
            "Follow-up ended whichever occurred later: visit or drop-out.",
            True,
            "v2_pos_whichever_later",
        ),
        (
            "Participants were censored from the registry data.",
            False,
            "v2_neg_no_temporal_keyword",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            True,
            "v3_pos_censoring_block",
        ),
        (
            "Exit criteria:\n(None specified)\n\nStudy ended in 2018.",
            False,
            "v3_neg_no_match_in_block",
        ),
        (
            "Methods:\nPatients were followed until transplant.",
            False,
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Patients were followed until transplant or 31 Dec 2020.",
            True,
            "v4_pos_until_date_and_event",
        ),
        ("Censored at death or end of study", True, "v4_pos_censored_at_death"),
        (
            "Participants were followed until outcome was reached.",
            False,
            "v4_neg_generic_until",
        ),
        (
            "Exit when appropriate, whichever came first.",
            False,
            "v4_neg_no_event_token",
        ),
        (
            "Recipients were censored at 5 years of follow-up, time of re-transplant, or administratively at end-of-study.",
            True,
            "v4_pos_censored_at_retransplant_or_end",
        ),
        (
            "Kidney transplant recipients were censored at the time of graft loss, death, or the end of the study period.",
            True,
            "v4_pos_censored_at_multiple_events",
        ),
        (
            "The primary endpoint was death-censored graft survival.",
            False,
            "v4_neg_death_censored_descriptive",
        ),
        (
            "Follow-up was censored from registry data after baseline.",
            False,
            "v4_neg_censored_after_baseline",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Patients were followed until transplant or death.",
            True,
            "v5_pos_followed_until",
        ),
