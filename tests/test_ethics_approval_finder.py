...
and v5 variants, using clinical/medical-style ethics approval and consent statements.
"""
import pytest
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "The IRB approved the protocol and written informed consent was obtained.",
            True,
            "v4_pos_with_consent",
        ),
        # positive: IRB + reviewed + protocol number nearby
        (
            "Ethics committee reviewed protocol #2021-45.",
            True,
            "v4_pos_with_protocol_number",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            True,
            "v5_pos_irb_number_consent",
        ),
        (
            "Protocol was approved by the ethics committee of ABC Hospital; informed consent was waived.",
            True,
            "v5_pos_committee_waived",
        ),
