...
@pytest.mark.parametrize(
    ...
    [
        (
            "Population-based registry data were analyzed.",
            True,
            "v4_pos_pop_based_registry",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "We used nationwide insurance claims data from 2010-2020.",
            True,
            "v5_pos_template_claims",
        ),
        (
            "EHR-derived database from 2005-2015 was analyzed.",
            True,
            "v5_pos_template_ehr",
        ),
