...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Master patient index was used for record linkage.",
            True,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "The study described linkage without object terms.",
            False,
            "v2_neg_no_object",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Data Linkage:\nRecords were linked deterministically.",
            True,
            "v3_pos_heading_linked",
        ),
        (
            "Record Linkage - We performed probabilistic matching.",
            True,
            "v3_pos_record_heading",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Records were probabilistically linked to registry data.",
            True,
            "v4_pos_probabilistic",
        ),
        (
            "Files were deterministically matched to hospital records.",
            True,
            "v4_pos_deterministic",
        ),
        ("Records were linked without specifying method.", False, "v4_neg_no_method"),
        (
            "Data linkage performed but method not described.",
            False,
            "v4_neg_method_missing",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Patient files were deterministically matched to national registry.",
            True,
            "v5_pos_template_deterministic",
        ),
        (
            "Records were linked but without template structure.",
            False,
            "v5_neg_loose_phrase",
        ),
    ],
