...
- Functional checks for v3, v4, and v5 (block-based, numeric/threshold-based,
  and template-based)
...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "Medication adherence was reported for all patients.",
            True,
            "v1_pos_medication_adherence",
        ),
        (
            "Compliance with therapy was assessed annually.",
            True,
            "v1_pos_compliance_with_therapy",
        ),
        (
            "We calculated the proportion of days covered (PDC).",
            True,
            "v1_pos_pdc",
        ),
        ...
        (
            "Good adherence to study procedures was expected.",
            False,
            "v1_trap_study_procedures",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            True,
            "v2_pos_adherence_defined",
        ),
        (
            "We calculated compliance using pill counts.",
            True,
            "v2_pos_compliance_calculated",
        ),
        ("MPR was measured across all patients.", True, "v2_pos_mpr_measured"),
        # Negative examples
        (
            "Adherence was high among participants.",
            False,
            "v2_neg_adherence_no_verb",
        ),
        (
            "Compliance to treatment was encouraged.",
            False,
            "v2_neg_compliance_encouraged",
        ),
        (
            "Medication adherence rates were noted.",
            False,
            "v2_neg_not_analytic",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "Adherence:\nPDC was calculated over 12 months.",
            True,
            "v3_pos_adherence_heading",
        ),
        (
            "Compliance:\nWe measured pill counts weekly.",
            True,
            "v3_pos_compliance_heading",
        ),
        # Negative: correct cue but outside relevant heading
        (
            "Results:\nAdherence was calculated using MPR.",
            False,
            "v3_neg_wrong_heading",
        ),
        (
            "Baseline:\nMedication adherence was noted.",
            False,
            "v3_neg_not_adherence_heading",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "Adherence was defined as PDC ≥ 0.8 over 12 months.",
            True,
            "v4_pos_pdc_threshold",
        ),
        (
            "Compliance was measured and MPR > 75% was recorded.",
            True,
            "v4_pos_mpr_threshold",
        ),
        (
            "Adherence was calculated; pill count ≥ 90% was used.",
            True,
            "v4_pos_pillcount_threshold",
        ),
        # Negative examples
        (
            "Adherence was defined but no numeric threshold given.",
            False,
            "v4_neg_no_threshold",
        ),
        (
            "Compliance was measured qualitatively.",
            False,
            "v4_neg_no_numeric",
        ),
        (
            "MPR mentioned but not calculated.",
            False,
            "v4_neg_no_verb_with_threshold",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Adherence was defined as MPR > 80% across the cohort.",
            True,
            "v5_pos_mpr_threshold",
        ),
        # Negative examples
        (
            "Adherence was encouraged by providing counseling.",
            False,
            "v5_neg_encouraged",
        ),
        (
            "PDC values were reported but no threshold defined.",
            False,
            "v5_neg_no_definition",
        ),
        (
            "Adherence was defined broadly without metrics.",
            False,
            "v5_neg_no_metric",
        ),
    ],
