...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "The primary outcome was changed after the first interim analysis.",
            True,
            "v1_pos_primary_changed",
        ),
        (
            "We added a new secondary outcome to measure quality of life.",
            True,
            "v1_pos_added_secondary",
        ),
        (
            "Outcome measures were revised due to protocol update.",
            True,
            "v1_pos_revised_outcome",
        ),
        (
            "The study amended the outcomes in response to regulatory feedback.",
            True,
            "v1_pos_amended_outcomes",
        ),
        # Trap / negatives
        (
            "There were significant changes in patient outcomes.",
            False,
...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "After the trial began, we added a new secondary outcome.",
            True,
            "v2_pos_after_trial_began",
        ),
        (
            "Primary outcome was changed midway through the study.",
            True,
            "v2_pos_midstudy_change",
        ),
        (
            "The outcomes were revised 3 months into the trial.",
            True,
            "v2_pos_3_months_into_trial",
        ),
        # Trap / negatives
        ("We changed the primary outcome last year.", False, "v2_trap_outside_trial"),
        (
            "Protocol amendments in prior studies revised outcomes.",
            False,
            "v2_trap_prior_study",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            True,
            "v3_pos_heading_added",
        ),
        # Negative: correct cue outside heading
        (
            "Results:\nThe primary outcome was changed midway through the study.",
            False,
...
@pytest.mark.parametrize(
    ...
    [
        # Positive examples
        (
            "Due to low recruitment, the primary outcome was changed midway.",
            True,
        ...
        # Negative examples
        (
            "The primary outcome was changed midway through the trial.",
            False,
            "v4_neg_no_reason",
        ),
        (
            "We added a secondary outcome after trial began.",
            False,
            "v4_neg_no_reason_phrase",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Outcomes were amended due to regulatory guidance in general.",
            False,
            "v5_neg_different_reason_format",
        ),
    ],
)
