...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            True,
            "v1_pos_control_group_simple",
        ),
        (
            "We included a comparator arm receiving standard of care.",
            True,
            "v1_pos_comparator_arm",
        ),
        (
            "Patients were divided into intervention and control groups.",
            True,
            "v1_pos_divided_into_groups",
        ),
        # ❌ Traps: generic or irrelevant usage
        (
            "Compared to baseline, HbA1c improved by week 12.",
            False,
            "v1_trap_compare_to_baseline",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "The comparator group received placebo throughout follow-up.",
            True,
            "v2_pos_comparator_group",
        ),
        (
            "Standard-of-care cohort served as a comparator.",
            True,
            "v2_pos_cohort_served_comparator",
        ),
        (
            "Patients in the control cohort were matched by age.",
            True,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            True,
            "v3_pos_comparator_heading",
        ),
        # ❌ Not within valid headings
        (
            "Methods:\nThe placebo group received no treatment.",
            False,
            "v3_neg_wrong_section_heading",
        ),
        (
            "Treatment allocation:\nStandard vs novel approach.",
            False,
            "v3_neg_no_comparator_heading",
        ),
    ],
)
...
# ─────────────────────────────
# Lighter Tests for v4 – Comparator + group term + explicit qualifier
# (matched, reference, unexposed)
# ─────────────────────────────
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "A matched comparator cohort receiving metformin was used as reference.",
            True,
            "v4_pos_matched_reference",
        ),
        (
            "The unexposed group served as a control arm.",
            True,
            "v4_pos_unexposed_control_group",
        ),
        # ❌ Missing qualifier
        ("A comparator cohort was included.", False, "v4_neg_generic_comparator"),
        (
            "Standard care served as comparator, no matching described.",
            False,
            "v4_neg_no_qualifier",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "A matched unexposed cohort served as comparator.",
            True,
            "v5_pos_matched_unexposed_template",
        ),
        (
            "The control group comprised patients receiving placebo.",
            True,
            "v5_pos_control_group_placebo",
        ),
        # ❌ Near misses or informal phrasing
        (
            "Control subjects received standard care.",
            False,
            "v5_neg_missing_served_as_comparator",
        ),
        (
            "Matched cohort was used for comparison.",
            False,
            "v5_neg_missing_control_keyword",
        ),
    ],
)
