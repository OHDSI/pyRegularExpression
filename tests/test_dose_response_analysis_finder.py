...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "A dose-response trend without analysis was noted.",
            False,
            "v2_neg_no_verb",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Exposure-response was evaluated using restricted cubic spline.",
            True,
            "v4_pos_spline",
        ),
        (
            "A dose-response was observed but no trend test performed.",
            False,
            "v4_neg_no_trend_keyword",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "A clear dose-response was observed (p-trend < 0.001).",
            True,
            "v5_pos_template",
        ),
        (
            "Dose-response relationship noted but no p-trend.",
            False,
            "v5_neg_loose_phrase",
        ),
    ],
