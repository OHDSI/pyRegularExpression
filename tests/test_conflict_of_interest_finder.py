...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            True,
            "v1_pos_disclosed_no_conflicts",
        ),
        (
            "Competing interests are reported in the appendix.",
            True,
            "v1_pos_competing_interests",
        ),
        (
            "Conflict of interest statement: none declared.",
            True,
            "v1_pos_conflict_statement",
        ),
        # Trap / negatives
        (
            "This study had conflicting evidence regarding outcomes.",
            False,
            "v1_trap_conflicting_evidence",
        ),
        ("The risk conflicts with prior assumptions.", False, "v1_trap_conflicts_with"),
        (
            "No disclosures were available from the database.",
            False,
            "v1_trap_nonfinancial_disclosure",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # Positive
        (
            "J.D. reports no conflicts of interest related to this work.",
            True,
            "v2_pos_reports_conflicts",
        ),
        (
            "The investigators declared competing interests regarding funding.",
            True,
            "v2_pos_declared_competing",
        ),
        (
            "No conflicts of interest were stated by the authors.",
            True,
            "v2_pos_stated_conflicts",
        ),
        # Trap examples
        (
            "Conflicts of interest are a concern in general science.",
            False,
            "v2_trap_generic_statement",
        ),
        (
            "Competing interests section (not disclosed here).",
            False,
            "v2_trap_no_disclosure_verb",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Discussion:\nThe authors disclose limitations.",
            False,
            "v3_neg_heading_not_coi",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            True,
            "v4_pos_declared_no_competing",
        ),
        # Negative
        (
            "The authors reported conflicts of interest but did not name companies.",
            False,
            "v4_neg_missing_company_or_no_phrase",
        ),
        (
            "Competing interests were mentioned, but no declaration was made.",
            False,
            "v4_neg_missing_verb",
        ),
    ],
