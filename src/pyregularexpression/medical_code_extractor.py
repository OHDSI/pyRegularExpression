"""
medical_code_extractor.py – extract medical codes from text.

For this example, we're using a simple regex pattern to simulate medical
code extraction.
...
def extract_medical_codes(
    ...
    Args:
        ...
        return_offsets: If True, return (start, end) character offsets instead
                        of the codes.
